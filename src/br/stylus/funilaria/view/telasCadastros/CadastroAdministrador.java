...
import br.stylus.funilaria.model.dao.cadastros.CadastroAdministradorDao;
...
public class CadastroAdministrador extends javax.swing.JFrame {
    ...
    CadastroAdministradorDao salvarAdmin = new CadastroAdministradorDao();   
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(40, 40, 430, 220);
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jTextFieldUsuarioAdmin, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabelUsuarioAdmin, javax.swing.GroupLayout.Alignment.TRAILING))
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabelConfiSenhaAdmin, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel4.setBounds(480, 40, 330, 220);
        ...
        jPanel2.setBounds(40, 270, 770, 100);
        ...
        jPanel3.setBounds(40, 380, 770, 100);
        ...
        jButtonCadAdmin.setBounds(690, 500, 110, 40);
        ...
        jButtonLimparCadAdmin.setBounds(600, 500, 90, 40);
...
private void receberDados() {
        //recebendo dados
    String nome = Validacoes.contemSoLetras(jTextFieldNomeAdmin.getText());
       ...
       if(Validacoes.isCPF(jFormattedTextFieldCpf.getText())){
         if( Validacoes.verificaEmail(jTextFieldEmailAdmin.getText())){
              ...
              if(VerificaBdPessoaFisica.verificaCpf(administrador) 
                 ...
                 || VerificaBdContato.verificaTelefone(contato)  
                 ...
                 || VerificaBdContato.verificaEmail(contato)){
                  ...
                  if (jPasswordFieldSenhaAdmin.getText().equals(jPasswordFieldConfSenhaAdmin.getText())){
                     //salvando dados
                      ...
                      TelaIntemediaria tela = new TelaIntemediaria();
