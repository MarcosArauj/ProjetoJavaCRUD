...
import br.stylus.funilaria.model.dao.cadastros.CadastroClienteDao;
...
public class CadastroClientePessoaFisica extends javax.swing.JFrame {
                ...
                .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelLayout.createSequentialGroup()
                        .addGroup(jPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelLayout.createSequentialGroup()
                                .addGap(126, 126, 126)
                                .addComponent(jTextFieldCadClienteNome, javax.swing.GroupLayout.PREFERRED_SIZE, 593, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void receberDados(){
       //recebendo os dados
        String nome = Validacoes.contemSoLetras(jTextFieldCadClienteNome.getText());
 ...
 public void salvarClientePessoaF() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroClientePessoaFisica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroClientePessoaFisica().setVisible(true);
            }
        });
    }
