...
public class FormTelaIntemediaria extends javax.swing.JFrame {

    public FormTelaIntemediaria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTelaIntemediaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormTelaIntemediaria().setVisible(true);
            }
        });
    }
