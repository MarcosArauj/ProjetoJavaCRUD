        ...
        conex.conexao();
         ...
         conex.executaSql("select fu.cod_funcionario, pf.nome, pf.cpf, pf.rg, pf.orgaoexpedidor, pf.data_nascimento, pf.sexo,\n" +
                          ...
                          "inner join contato as c\n" +
                           "on fu.cod_contato = c.cod_contato where pf.nome like '"+nome.getPesquisaFun()+"%'");
        try {
            conex.rs.first();
     ...
     public Funcionario pesquisaCargo(Funcionario cargo){
        conex.conexao();
         ...
         conex.executaSql("select fu.cod_funcionario, pf.nome, pf.cpf, pf.rg, pf.orgaoexpedidor, pf.data_nascimento, pf.sexo,\n" +
                          ...
                          "on fu.cod_pessoafisica = pf.cod_pessoafisica\n" +
                          "inner join contato as c\n" +
                           "on fu.cod_contato = c.cod_contato where fu.cargo like '"+cargo.getPesquisaFun()+"%'");
        try {
            conex.rs.first();
      ...
      public Funcionario pesquisaCpf(Funcionario cpf){
        conex.conexao();
         ...
         conex.executaSql("select fu.cod_funcionario, pf.nome, pf.cpf, pf.rg, pf.orgaoexpedidor, pf.data_nascimento, pf.sexo,\n" +
                          ...
                          "on fu.cod_pessoafisica = pf.cod_pessoafisica\n" +
                          "inner join contato as c\n" +
                           "on fu.cod_contato = c.cod_contato where pf.cpf like '"+cpf.getPesquisaFun()+"%'");
        try {
            conex.rs.first();
