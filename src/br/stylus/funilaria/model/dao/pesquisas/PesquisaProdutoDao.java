...
public class PesquisaProdutoDao {
    ...
    ConexaoBD conex = new ConexaoBD();
     ...
     public Produtos pesquisarMarca (Produtos marca){
        ...
        conex.conexao();
        conex.executaSql("select * from produtos where marca_produto ='"+marca.getPesquisaproduto()+"'");
        try {
            conex.rs.first();
            do{
            ...
            marca.setStatus(conex.rs.getString("status"));
           }while(conex.rs.next());
     ...
     public Produtos pesquisarTipo (Produtos tipo){
      ...
      public Produtos pesquisarDescricao (Produtos descricao){
        ...
        try {
            ...
            descricao.setStatus(conex.rs.getString("status"));
           }while(conex.rs.next());
        } catch (SQLException ex) {
